      ...
      <header className="app-header">
        ...
        <div className="nav-actions">
           ...
           <div className="social-links-header">
              <a aria-label="GitHub" title="GitHub" className="header-icon" href={SOCIAL_LINKS.github} target="_blank" rel="noreferrer">
              ...
              <a aria-label="LinkedIn" title="LinkedIn" className="header-icon" href={SOCIAL_LINKS.linkedin} target="_blank" rel="noreferrer">
              ...
              <a aria-label="Email" title="Email" className="header-icon" href={SOCIAL_LINKS.email}>
              ...
              <a aria-label="Resume / CV" title="Resume / CV" className="header-icon" href={SOCIAL_LINKS.cv} target="_blank" rel="noreferrer">
                 <svg style={{ width: '1.25rem', height: '1.25rem' }} fill="currentColor" viewBox="0 0 24 24"><path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>
              </a>
           </div>
