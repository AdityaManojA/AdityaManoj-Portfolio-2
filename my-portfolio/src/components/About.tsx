      ...
      <div className="about-grid">
        ...
        <div className="about-card bio-card">
          ...
          <div className="section-text" style={{ marginBottom: 0 }}>
            ...
            <br/>
            <p>
              I blend technical expertise with artistic vision. Whether it's building amazing and functional apps or sculpting 3D models, I am a quick learner with a knack for bringing abstract ideas to life.
            </p>
          </div>
        </div>
        ...
        <div className="about-card stats-card">
          <div className="stat-row">
            <div className="stat-item">
              ...
              <div className="stat-label">Repositories on Git</div>
            </div>
            <div className="stat-item">
        ...
        <div className="about-card what-i-do-card">
          ...
          <div className="do-grid">
            ...
            <div className="do-item">
              ...
              <div className="do-title">Developer</div>
            </div>
            <div className="do-item">
              ...
              <div className="do-title">Designer</div>
            </div>
            <div className="do-item">
